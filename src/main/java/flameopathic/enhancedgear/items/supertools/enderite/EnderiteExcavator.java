...
public class EnderiteExcavator extends ShovelItem {
    public EnderiteExcavator(ToolMaterial material, float attackDamage, float attackSpeed, Settings settings) {
